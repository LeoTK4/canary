...
void ConfigFunctions::init(lua_State* L) {
	...
	registerEnumIn(L, "configKeys", ALLOW_DUAL_WIELDING)// Dual Wielding Test
	registerEnumIn(L, "configKeys", DUAL_WIELDING_SPEED_RATE)// Dual Wielding Test
	registerEnumIn(L, "configKeys", DUAL_WIELDING_DAMAGE_RATE)// Dual Wielding Test
